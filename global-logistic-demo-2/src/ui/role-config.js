...
const roleConfig = {
  ...
  [Roles.CARRIER_OWNER]: {
    ...
    actions: [ActionTypes.ADD_COMPANY_DRIVER, ActionTypes.ADD_VEHICLE, ActionTypes.HIRE_COMPANY_EMPLOYEE, ActionTypes.ACCEPT_CARRIER, ActionTypes.ASSIGN_DRIVER, ActionTypes.REQUEST_TECHNICAL_SERVICE]
  },
